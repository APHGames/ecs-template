...
/**
 * Wrapper for PIXI.AnimatedSprite
 */
export default class AnimatedSprite extends PIXI.AnimatedSprite implements GameObject {
    _proxy: GameObjectProxy;

    constructor(name: string = '', textures: PIXI.Texture[] | PIXI.AnimatedSprite.FrameObject[], autoUpdate?: boolean) {
    ...
    asAnimatedSprite(): AnimatedSprite { return this; }
